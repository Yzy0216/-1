...
Page({
  ...
  bindCounty: function(e) {
    ...
    wx.request({
        ...
        success: (res) => {
            var province=res.data.result.address_components.province
            var city=res.data.result.address_components.city
            var district=res.data.result.address_components.district
            // var street=res.data.result.address_components.street
var addressList=[city,district]
